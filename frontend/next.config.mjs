        ...
        headers: [
          ...
          { key: 'Cross-Origin-Opener-Policy', value: 'same-origin' },
          {
            ...
            value: [
              ...
              "frame-src blob:",
              "object-src blob:",
              `connect-src 'self' ${isDev ? 'http://localhost:3000 ws://localhost:3000 ws://localhost:3001' : 'https://api.noctcom.com wss://api.noctcom.com'} https://*.googleapis.com https://*.firebaseio.com https://fcmregistrations.googleapis.com https://cloudflareinsights.com https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com`,
