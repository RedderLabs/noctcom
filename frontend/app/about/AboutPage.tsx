      ...
      <div className="flex-1 max-w-3xl mx-auto px-6 py-12 w-full">
        ...
        <div className="mb-10">
          ...
          <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
            Noctcom lo construye <strong className="text-[var(--color-text-primary)] font-medium">Julián Rodríguez</strong>,
            desarrollador autodidacta, bajo la marca <strong className="text-[var(--color-text-primary)] font-medium">Redder Labs</strong>.
        ...
        <Section icon={Code2} title="Cómo llegué aquí">
          ...
          <blockquote className="border-l-2 border-violet-500/40 pl-4 py-1 text-[var(--color-text-secondary)] italic">
            «Todo lo que sé lo aprendí leyendo código de otros, rompiendo cosas hasta entender
            por qué se rompían.»
          </blockquote>
          <p className="text-[var(--color-text-tertiary)] text-sm leading-relaxed mt-4">
        ...
        <Section icon={Activity} title="Otros proyectos de Redder Labs">
          <a
            ...
            className="group flex items-start gap-4 p-5 rounded-xl border border-[var(--color-border-faint)] bg-[var(--color-bg-surface)] hover:border-[var(--color-border-subtle)] transition-all"
          >
        ...
        <Section icon={Mail} title="Hablemos">
          <div className="grid sm:grid-cols-3 gap-3">
            ...
            >
              <Github className="size-4 text-[var(--color-text-secondary)]" />
              <div className="flex-1 min-w-0">
                <span className="text-sm font-medium block">GitHub</span>
                <span className="text-[10px] text-[var(--color-text-tertiary)] font-mono">RedderLabs</span>
              </div>
            </a>
            <a
              ...
              className="flex items-center gap-3 p-4 rounded-xl border border-[var(--color-border-faint)] bg-[var(--color-bg-surface)] hover:border-[var(--color-border-subtle)] transition-all group"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="size-3.5 text-[var(--color-text-secondary)]">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
              <div className="flex-1 min-w-0">
                <span className="text-sm font-medium block">X</span>
                <span className="text-[10px] text-[var(--color-text-tertiary)] font-mono">@noctcom</span>
              </div>
            </a>
            <a
          ...
          <p className="text-xs text-[var(--color-text-tertiary)] leading-relaxed mt-4">
...
function Section({ icon: Icon, title, children }: { icon: typeof Code2; title: string; children: React.ReactNode }) {
  return (
    <section className="mb-10">
      <h2 className="flex items-center gap-2 text-sm font-semibold uppercase tracking-wider text-[var(--color-text-secondary)] mb-4">
